...
void QLegendWnd::calculateGeometry(void)
{
    ...
    orbitwidth_ = fm.horizontalAdvance("abcdefghk");
    sepwidth_ = fm.horizontalAdvance("abc");

    hmargin3_ = hmargin1_ + sepwidth_ + fm.maxWidth();

    me = hmargin1_ + fm.horizontalAdvance("Non-degenerate:");

    e = hmargin2_ + fm.horizontalAdvance("Saddle");
    if (me < e)
        me = e;
    e = hmargin2_ + fm.horizontalAdvance("Stable Node");
    if (me < e)
        me = e;
    e = hmargin2_ + fm.horizontalAdvance("Unstable Node");
    if (me < e)
        me = e;
    e = hmargin2_ + fm.horizontalAdvance("Weak Focus");
    if (me < e)
        me = e;
    e = hmargin2_ + fm.horizontalAdvance("Stable Weak Focus");
    if (me < e)
        me = e;
    e = hmargin2_ + fm.horizontalAdvance("Unstable Weak Focus");
    if (me < e)
        me = e;
    e = hmargin2_ + fm.horizontalAdvance("Center");
    if (me < e)
        me = e;
    e = hmargin2_ + fm.horizontalAdvance("Stable Strong Focus");
    if (me < e)
        me = e;
    e = hmargin2_ + fm.horizontalAdvance("Unstable Strong Focus");
    if (me < e)
        me = e;

    e = hmargin1_ + fm.horizontalAdvance("Separatrices:");
    if (me < e)
        me = e;
    e = hmargin3_ + fm.horizontalAdvance("Stable");
    if (me < e)
        me = e;
    e = hmargin3_ + fm.horizontalAdvance("Unstable");
    if (me < e)
        me = e;
    e = hmargin3_ + fm.horizontalAdvance("Center-Stable");
    if (me < e)
        me = e;
    e = hmargin3_ + fm.horizontalAdvance("Center-Unstable");
    if (me < e)
        me = e;
    ...
    me = hmargin4_ + fm.horizontalAdvance("Semi-hyperbolic");
    e = hmargin5_ + fm.horizontalAdvance("Saddle-Node");
    if (me < e)
        me = e;
    e = hmargin5_ + fm.horizontalAdvance("Stable Node");
    if (me < e)
        me = e;
    e = hmargin5_ + fm.horizontalAdvance("Unstable Node");
    if (me < e)
        me = e;
    e = hmargin5_ + fm.horizontalAdvance("Saddle");
    if (me < e)
        me = e;

    e = hmargin5_ + fm.horizontalAdvance("Non-elementary:");
    if (me < e)
        me = e;
    e = hmargin4_ + fm.horizontalAdvance("Orbits:");
    if (me < e)
        me = e;
    e = hmargin4_ + fm.horizontalAdvance("Curve of Singularities:");
    if (me < e)
        me = e;
    e = hmargin4_ + fm.horizontalAdvance("Limit Cycles:");
    if (me < e)
        me = e;
