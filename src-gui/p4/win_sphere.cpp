...
void QWinSphere::keyPressEvent(QKeyEvent *e)
{
    ...
    if (id == Qt::Key_C &&
        ((bs & Qt::ShiftModifier) || ((bs & (Qt::AltModifier | Qt::ShiftModifier)) == (Qt::AltModifier | Qt::ShiftModifier)))) {
...
void QWinSphere::mouseMoveEvent(QMouseEvent *e)
{
    ...
    */
    ...
    if (MATHFUNC(is_valid_viewcoord)(wx, wy, pcoord)) {
        ...
        case TYPEOFVIEW_PLANE:
            if (g_VFResults.typeofstudy_ == TYPEOFSTUDY_ONE)
                buf = QString("Local study");
            else
                buf = QString("Planar view");
            break;
        case TYPEOFVIEW_SPHERE:
            if (g_VFResults.p_ == 1 && g_VFResults.q_ == 1)
        ...
        case TYPEOFVIEW_U1:
            ...
            break;
        case TYPEOFVIEW_V1:
            buf = QString("The V1 chart");
            break;
        case TYPEOFVIEW_U2:
            buf = QString("The U2 chart");
            break;
        case TYPEOFVIEW_V2:
            buf = QString("The V2 chart");
            break;
        }
    }
