...
#include "../../../../../src-gui/p4/win_sphere.h"
...
namespace {
struct qt_meta_tag_ZN10QWinSphereE_t {};
} // unnamed namespace

template <> constexpr inline auto QWinSphere::qt_create_metaobjectdata<qt_meta_tag_ZN10QWinSphereE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'keyPressEvent'
        QtMocHelpers::SlotData<void(QKeyEvent *)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 12, 4 },
        }}),
        // Slot 'calculateHeightFromWidth'
        QtMocHelpers::SlotData<void(int *, int *, int, double)>(13, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 14, 15 }, { 0x80000000 | 14, 16 }, { QMetaType::Int, 17 }, { QMetaType::Double, 18 },
        }}),
    ...
    return QtMocHelpers::metaObjectData<QWinSphere, qt_meta_tag_ZN10QWinSphereE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QWinSphere::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10QWinSphereE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10QWinSphereE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10QWinSphereE_t>.metaTypes,
    nullptr
} };

void QWinSphere::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<QWinSphere *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->calculateHeightFromWidth((*reinterpret_cast< std::add_pointer_t<int*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<double>>(_a[4]))); break;
...
void *QWinSphere::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10QWinSphereE_t>.strings))
